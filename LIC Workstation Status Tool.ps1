...
#	- added Imaging1											#
#	- adopted extended features from Admin Tool					#
#	- added Systems												#
...
# ps2exe "LIC Workstation Status Tool.ps1" ".\LIC Workstation Status Tool.exe" -title "LIC Workstation Status Tool" -company "Albert-Ludwigs-Universität Freiburg" -copyright "Tobias Wernet" -version "2.8a" -product "LIC Workstation Status Tool by Life Imaging Center (LIC)" -credentialGUI -iconfile "C:\Temp\Logos\alu.ico" -DPIAware -supportOS -noconsole
#
##
...
$version = "2.8a"
$lastdate = "30.05.2023"
$tool = "LIC Workstation Status Tool"
...
# Function to collect session status
...
{
	# Calling handler_Status Function
	handler_Status
	...
	$objForm.Text = "$tool"
	#$objForm.Size = New-Object System.Drawing.Size(770,500) 
	...
	#This creates a label for the LIC Computer hostname
	$posx = 40
	$posy = 10
	$sizex = 30
	$sizey = 160
	...
	$objSeparator1.Location = New-Object System.Drawing.Size(700,40) 
	...
	$timer2 = New-Object System.Windows.Forms.Timer -Property @{Interval = 10000} 
	$timer2.start()
